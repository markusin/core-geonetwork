...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  xmlns:gmi="http://sdi.eurac.edu/metadata/geonetwork/iso19139-2">
  ...
  <!-- ================================================================= -->
  <xsl:template match="/gmi:Mi_Metadata|/*[@gco:isoType='gmd:MD_Metadata']">
    <xsl:copy>
      <xsl:copy-of select="@*"/>
      <xsl:copy-of
			...
			<gmd:dataQualityInfo>
				<gmd:DQ_DataQuality>
					...
					<!--<gmd:lineage>
						<gmd:LI_Lineage>
							<gmd:statement>
								<gco:CharacterString> LINEAGE LINEAGE
									</gco:CharacterString>
							</gmd:statement>
						</gmd:LI_Lineage>
					</gmd:lineage> -->
							...
							<gmd:result>
								<gmd:DQ_ConformanceResult>
									<gmd:specification>
										<gmd:CI_Citation>
											<gmd:title>
												<gco:CharacterString>INSPIRE
													Implementing
													rules</gco:CharacterString>
											</gmd:title>
											<gmd:date>
												<gmd:CI_Date>
													<gmd:date>
									...
									<gmd:explanation>
										<gco:CharacterString>-- more information on
											the test --</gco:CharacterString>
									</gmd:explanation>
								</gmd:DQ_ConformanceResult>
								<gmd:DQ_QuantitiativeResult>
									<gmd:errorStatistic>
										<gco:CharacterString> Conformant
											</gco:CharacterString>
									</gmd:errorStatistic>
								</gmd:DQ_QuantitiativeResult>
							</gmd:result>
