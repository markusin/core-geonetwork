...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="gmie:MIE_Metadata/gmd:fileIdentifier|gmie:MIE_Metadata/gmd:parentIdentifier" priority="10"/>
	...
	<xsl:template match="gmd:metadataStandardName[@gco:nilReason='missing' or gco:CharacterString='']" priority="10">
		<xsl:copy>
			<gco:CharacterString>ISO 19115:2003/19139 Profil EURAC</gco:CharacterString>
		</xsl:copy>
	</xsl:template>
