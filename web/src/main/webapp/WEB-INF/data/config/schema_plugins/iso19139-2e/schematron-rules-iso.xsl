...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml"
	xmlns:gml="http://www.opengis.net/gml" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:srv="http://www.isotc211.org/2005/srv"
	xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:geonet="http://www.fao.org/geonetwork" xmlns:xlink="http://www.w3.org/1999/xlink"
	...
	<!--SCHEMA SETUP -->
	<xsl:template match="/">
		<svrl:schematron-output title="Schematron validation for ISO&#10;&#9;&#9;19115-2e(19139-2e)"
			schemaVersion="" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
			<xsl:comment>
			...
			<svrl:ns-prefix-in-attribute-values uri="http://sdi.eurac.edu/metadata/iso19139-2/schema/gmi" prefix="gmi" />
			<svrl:ns-prefix-in-attribute-values uri="http://sdi.eurac.edu/metadata/iso19139-2/schema/gmie" prefix="gmie" />
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<xsl:template match="//gml:DirectPositionType" priority="1000" mode="M8">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gml:DirectPositionType" id="CRSLabelsPosType" />
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template
		match="//gmd:MD_LegalConstraints[gmd:accessConstraints/gmd:MD_RestrictionCode/@codeListValue='otherRestrictions']    |//*[@gco:isoType='gmd:MD_LegalConstraints' and gmd:accessConstraints/gmd:MD_RestrictionCode/@codeListValue='otherRestrictions']"
		priority="1001" mode="M10">
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template
		match="//gmd:MD_LegalConstraints[gmd:useConstraints/gmd:MD_RestrictionCode/@codeListValue='otherRestrictions']    |//*[@gco:isoType='gmd:MD_LegalConstraints' and gmd:accessConstraints/gmd:MD_RestrictionCode/@codeListValue='otherRestrictions']"
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<xsl:template match="//gmd:MD_Band[gmd:maxValue or gmd:minValue]" priority="1000" mode="M11">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gmd:MD_Band[gmd:maxValue or gmd:minValue]" />
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template
		match="//gmd:DQ_DataQuality[gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode/@codeListValue='dataset'     or gmd:scope/gmd:DQ_Scope/gmd:level/gmd:MD_ScopeCode/@codeListValue='series']"
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template match="//gmd:MD_DataIdentification|//*[@gco:isoType='gmd:MD_DataIdentification']" priority="1000"
		mode="M20">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template match="//gmie:MIE_Metadata|//*[@gco:isoType='gmd:MD_Metadata']" priority="1000" mode="M23">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gmie:MIE_Metadata|//*[@gco:isoType='gmd:MD_Metadata']" />
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template match="//gmie:MIE_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmd:MD_Metadata']/gmd:hierarchyLevel"
		priority="1000" mode="M29">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
			context="//gmie:MIE_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmd:MD_Metadata']/gmd:hierarchyLevel" />
